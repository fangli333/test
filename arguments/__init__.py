...
class OptimizationParams(ParamGroup):
    def __init__(self, parser):
        ...
        #ROS-Cam:
        self.coarse_camera_learn = 200
        self.camera_learn = 250

        self.raw_gamma_lr = 0.01

        self.cali_lr_init = 0.01
        self.cali_lr_final = 0.01
        self.cali_lr_delay_mult = 0.01
        self.cali_lr_max_steps = self.camera_learn

        self.focal_lr_init = 1.0
        self.focal_lr_final = 1.0
        self.focal_lr_delay_mult = 0.001
        self.focal_lr_max_steps = self.camera_learn

        self.quaternion_lr_init = 0.01
        self.quaternion_lr_final = 0.01
        self.quaternion_lr_delay_mult = 0.01
        self.quaternion_lr_max_steps = self.camera_learn

        self.t_lr_init = 0.01
        self.t_lr_final = 0.01
        self.t_lr_delay_mult = 0.01
        self.t_lr_max_steps = self.camera_learn
